...
<script src="EliminarScript.js"></script>
  ...
  <body>
    <div class="container">
          ...
          <ul>
            <li><a href="#">Categorías</a>
              <ul>
                ...
                <li><a href="#" onclick="location.reload();">CONGELADOS</a></li>
                <li><a href="adminFrescos.php">FRESCOS</a></li>
              </ul>
            </li>
          </ul>
        </nav>
      ...
      <h3 class="tituloCongelados">CONGELADOS</h3>
      <form class="formularioCongelado" action="../DB/procesar_formularioCongelados.php" method="post" onsubmit="agregarProducto(); return false;" enctype="multipart/form-data">
      <div class="columna">
    ...
    <div class="columna">
      ...
      <button type="submit" class="botonCongelado">Agregar Producto</button>
    </div>
  </form>
</div>
    ...
    <script>
     ...
     function agregarProducto() {
        ...
        request.open('POST', '../DB/procesar_formularioCongelados.php');
...
$sql = "SELECT nombre, descripcion, presentacion, src, categoria_id FROM producto WHERE categoria_id = 2 ORDER BY nombre";
