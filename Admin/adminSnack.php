        ...
        <nav class="items">
          <ul>
            <li><a href="#">Categorías</a>
              <ul>
                <li><a href="#" onclick="location.reload();">SNACK</a></li>
        ...
        <nav class="person">
          <ul>
            <li><a href="#">Hola, <?php echo $_SESSION['nombre_completo']; ?></a>
              <ul>
                <li><a href="../DB/cerrarsesion.php">Cerrar Sesion</a></li>
              </ul>
            </li>
          </ul>
        </nav>
      </header>
      <h3 class="tituloSnack">SNACK</h3>
      <form class="formulario" action="../DB/procesar_formularioSnack.php" method="post" onsubmit="agregarProducto(); return false;" enctype="multipart/form-data">
    <div class="columna">
    ...
    <script>
     ...
     function agregarProducto() {
        ...
        const request = new XMLHttpRequest();
            request.open('POST', '../DB/procesar_formularioSnack.php');
...
$sql = "SELECT nombre, descripcion, presentacion, src, categoria_id FROM producto WHERE categoria_id = 1 ORDER BY nombre";
